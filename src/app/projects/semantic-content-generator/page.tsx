  ...
  return (
    <Container className="mt-16 lg:mt-32">
      <div className="xl:relative">
        <div className="mx-auto max-w-2xl">
          ...
          <div className="mt-8 flex gap-4">
            <Button href="https://sequesto-content-optimizer.jenoffvanhulle.com/" target="_blank">
              View Application
            </Button>
            <Button href="mailto:contact@jenoffvanhulle.com" variant="secondary">
      ...
      <div className="mt-16 sm:mt-20">
        <div className="relative isolate overflow-hidden bg-zinc-900 px-6 py-24 shadow-2xl sm:rounded-3xl sm:px-16 lg:flex lg:gap-x-20 lg:px-24">
          ...
          <div className="relative mt-16 h-80 lg:mt-8">
            ...
            <div className="absolute left-0 top-0 w-[57rem] max-w-none rounded-md bg-white/5 ring-1 ring-white/10 h-[40rem] flex items-center justify-center text-white/20 text-4xl font-bold">
      ...
      <div className="mt-16 md:mt-20">
        ...
        <div className="mt-6 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {[
            ...
            { title: 'Multilingual Support', description: 'Analyze and optimize content in over 50 languages.' },
            { title: 'Competitor Analysis', description: 'Compare your content against top-ranking competitors to identify gaps.' },
            { title: 'Knowledge Base Integration', description: 'Connects with Notion to use your existing knowledge base for context-aware recommendations.' },
          ].map((feature) => (
